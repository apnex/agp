...
| `contract/valid-variants.test.js` | Schema-valid encode/decode preservation for exactly seven wire variants | `fixtures/valid-wire-messages.json` | Negative classification and contextual semantics |
